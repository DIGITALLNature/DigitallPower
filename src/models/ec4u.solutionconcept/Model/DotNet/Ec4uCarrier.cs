...
namespace ec4u.solutionconcept
{
	...
	public partial class Ec4uCarrier : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
		...
		/// <summary>
		/// 1:N ec4u_carrier_to_carrier_dependency_check_on_carrier_id
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ec4u_carrier_to_carrier_dependency_check_on_carrier_id")]
		public System.Collections.Generic.IEnumerable<Ec4uCarrierDependencyCheck> Ec4uCarrierToCarrierDependencyCheckOnCarrierId
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Ec4uCarrierDependencyCheck>("ec4u_carrier_to_carrier_dependency_check_on_carrier_id", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("Ec4uCarrierToCarrierDependencyCheckOnCarrierId");
				this.SetRelatedEntities<Ec4uCarrierDependencyCheck>("ec4u_carrier_to_carrier_dependency_check_on_carrier_id", null, value);
				this.OnPropertyChanged("Ec4uCarrierToCarrierDependencyCheckOnCarrierId");
			}
		}

		/// <summary>
		/// 1:N ec4u_carrier_to_carrier_missing_dependency_on_carrier_id
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ec4u_carrier_to_carrier_missing_dependency_on_carrier_id")]
		public System.Collections.Generic.IEnumerable<Ec4uCarrierMissingDependency> Ec4uCarrierToCarrierMissingDependencyOnCarrierId
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Ec4uCarrierMissingDependency>("ec4u_carrier_to_carrier_missing_dependency_on_carrier_id", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("Ec4uCarrierToCarrierMissingDependencyOnCarrierId");
				this.SetRelatedEntities<Ec4uCarrierMissingDependency>("ec4u_carrier_to_carrier_missing_dependency_on_carrier_id", null, value);
				this.OnPropertyChanged("Ec4uCarrierToCarrierMissingDependencyOnCarrierId");
			}
		}

		/// <summary>
		/// 1:N ec4u_carrier_to_workbench_history_on_carrier
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ec4u_carrier_to_workbench_history_on_carrier")]
		public System.Collections.Generic.IEnumerable<Ec4uWorkbenchHistory> Ec4uCarrierToWorkbenchHistoryOnCarrier
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Ec4uWorkbenchHistory>("ec4u_carrier_to_workbench_history_on_carrier", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("Ec4uCarrierToWorkbenchHistoryOnCarrier");
				this.SetRelatedEntities<Ec4uWorkbenchHistory>("ec4u_carrier_to_workbench_history_on_carrier", null, value);
				this.OnPropertyChanged("Ec4uCarrierToWorkbenchHistoryOnCarrier");
			}
		}

		/// <summary>
		/// 1:N ec4u_carrier_to_workbench_on_carrier
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ec4u_carrier_to_workbench_on_carrier")]
		public System.Collections.Generic.IEnumerable<Ec4uWorkbench> Ec4uCarrierToWorkbenchOnCarrier
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Ec4uWorkbench>("ec4u_carrier_to_workbench_on_carrier", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("Ec4uCarrierToWorkbenchOnCarrier");
				this.SetRelatedEntities<Ec4uWorkbench>("ec4u_carrier_to_workbench_on_carrier", null, value);
				this.OnPropertyChanged("Ec4uCarrierToWorkbenchOnCarrier");
			}
		}

		/// <summary>
		/// 1:N ec4u_carrier_to_workbench_on_target_carrier
		/// </summary>	
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ec4u_carrier_to_workbench_on_target_carrier")]
		public System.Collections.Generic.IEnumerable<Ec4uWorkbench> Ec4uCarrierToWorkbenchOnTargetCarrier
		{
			[DebuggerNonUserCode]
			get
			{
				return this.GetRelatedEntities<Ec4uWorkbench>("ec4u_carrier_to_workbench_on_target_carrier", null);
			}
			[DebuggerNonUserCode]
			set
			{
				this.OnPropertyChanging("Ec4uCarrierToWorkbenchOnTargetCarrier");
				this.SetRelatedEntities<Ec4uWorkbench>("ec4u_carrier_to_workbench_on_target_carrier", null, value);
				this.OnPropertyChanged("Ec4uCarrierToWorkbenchOnTargetCarrier");
			}
		}
