...
namespace dgt.power.dataverse
{
	...
	public partial class SLA : Entity, INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public static class Relations
        {
            ...
            {
				public const string AdxInviteredemptionSlaSlaid = "adx_inviteredemption_sla_slaid";
				public const string AdxInviteredemptionSlaSlainvokedid = "adx_inviteredemption_sla_slainvokedid";
				public const string AdxPortalcommentSlaSlaid = "adx_portalcomment_sla_slaid";
				public const string AdxPortalcommentSlaSlainvokedid = "adx_portalcomment_sla_slainvokedid";
				...
				public const string MsdynApprovalSlaSlaid = "msdyn_approval_sla_slaid";
				public const string MsdynApprovalSlaSlainvokedid = "msdyn_approval_sla_slainvokedid";
				public const string MsdynBookingalertSlaSlaid = "msdyn_bookingalert_sla_slaid";
				public const string MsdynBookingalertSlaSlainvokedid = "msdyn_bookingalert_sla_slainvokedid";
				public const string MsdynCopilottranscriptSlaSlaid = "msdyn_copilottranscript_sla_slaid";
				public const string MsdynCopilottranscriptSlaSlainvokedid = "msdyn_copilottranscript_sla_slainvokedid";
				...
				public const string MsdynOcoutboundmessageSlaSlaid = "msdyn_ocoutboundmessage_sla_slaid";
				public const string MsdynOcoutboundmessageSlaSlainvokedid = "msdyn_ocoutboundmessage_sla_slainvokedid";
