...
{
    public partial class D365EntityRefTemplate
    {
        ...
        public D365EntityRefTemplate(string typingPath, EntityMetadata entity, CodeGenerationConfig cfg, int systemLanguage)
        {
        ...
        private IEnumerable<AttributeMetadata> Filter(AttributeMetadata[] attributes)
        {
            ...
            if (_cfg.EntityRefFilters.Count() > 0)
            {
                var match = _cfg.EntityRefFilters.FirstOrDefault(e => e.Entity == EntityMetadata.LogicalName);
