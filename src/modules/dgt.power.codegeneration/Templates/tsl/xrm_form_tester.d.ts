declare namespace XrmForm.Tester {
	...
	> {
		...
		getAttribute<T extends Xrm.Attributes.Attribute>(
			attributeName: TAttributeNames,
		): T | null;
		getControl<T extends Xrm.Controls.Control>(
		...
		getLoadExecutionContext(): Xrm.Events.EventContext;
	...
	export type XrmFormMockControlType =
		...
		| "quickView"
		| "string";
	export type XrmFormMockAttributeType =
		| "boolean"
		| "date"
		| "lookup"
		| "multiSet"
