 ...
 foreach(var sdkMessage in Filter(SdkMessages))
{
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(sdkMessage.Name));
            
            #line default
            #line hidden
            this.Write(" = \"");
            
            this.Write(this.ToStringHelper.ToStringWithCulture(sdkMessage.Message));
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class SdkMessagesTemplateBase
    {
        #region Fields
