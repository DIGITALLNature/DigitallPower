...
internal static class Processor
{
    ...
    public static Package CreatePluginPackage(Package packageLocal, IOrganizationService service, string solutionPrefix)
    {
        ...
        AnsiConsole.Markup(CultureInfo.InvariantCulture, "Create Package [green]{0} ({1})[/]", package.Name, package.Version);
        package.Id = service.Create(package);
