...
public class PluginStepImage : IEquatable<PluginStepImage>
{
    ...
    [IgnoreDataMember]
    public string TypeCode { get; set; } = dataverse.SdkMessageProcessingStepImage.EntityLogicalName;

    [IgnoreDataMember]
    public Guid ParentId { get; set; }

    [IgnoreDataMember]
    public string ParentTypeCode { get; set; } = dataverse.SdkMessageProcessingStep.EntityLogicalName;
