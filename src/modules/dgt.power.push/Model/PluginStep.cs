...
public class PluginStep : IEquatable<PluginStep>
{
    ...
    public List<PluginStepImage> PluginStepImages { get; init; } = new List<PluginStepImage>();
    ...
    [IgnoreDataMember]
    public string MessageTypeCode { get; init; } = SdkMessage.EntityLogicalName;

    [IgnoreDataMember]
    public Guid MessageFilterId { get; set; }

    [IgnoreDataMember]
    public string MessageFilterTypeCode { get; init; } = SdkMessageFilter.EntityLogicalName;

    [IgnoreDataMember]
    public Guid Id { get; init; }

    [IgnoreDataMember]
    public string TypeCode { get; init; } = SdkMessageProcessingStep.EntityLogicalName;
    ...
    [IgnoreDataMember]
    public string ParentTypeCode { get; init; } = dataverse.PluginType.EntityLogicalName;
