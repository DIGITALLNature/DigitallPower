...
public class TableRootComponentBehaviorRuleTests : LintTestsBase<LintRunCommand>
{
    private const string SolutionName = "sample_solution";

    protected override CommandTestContext<LintRunCommand, LintVerb> GetContext() => CreateContext();
    ...
    private CommandTestContext<LintRunCommand, LintVerb> CreateContext()
    {
        return GetBuilder()
