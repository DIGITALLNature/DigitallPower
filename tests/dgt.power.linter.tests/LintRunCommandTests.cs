...
public class LintRunCommandTests : LintTestsBase<LintRunCommand>
{
    private const string SolutionName = "sample_solution";

    protected override CommandTestContext<LintRunCommand, LintVerb> GetContext() =>
        GetBuilder()
    ...
    public async Task Execute_WithBaselineContainingTheFinding_SuppressesItFromTheFailGate()
    {
        ...
        var baselineRunResult = context.Execute(new LintVerb
        {
            Solutions = SolutionName,
            Config = configPath,
            Baseline = baselinePath,
        ...
        var gatedResult = context.Execute(new LintVerb
        {
            Solutions = SolutionName,
            Config = configPath,
            Baseline = baselinePath,
